...
class train_test_process():
    def __init__(self, out_path, loss_type = "balanced", tra_batch_size = 128, val_batch_size = 128, test_batch_size = 32, features = 100, lr = 0.001, n_epoch = 50, early_stop = 25, thresh = 0.5): #lr = 0.00001,
...
if encode_method == 'W2V':
   ...
   w2v_model = []
   os.makedirs(out_path + '/' + deep_method + '/' + encode_method,exist_ok=True)#+ '_' + str(kmer)
